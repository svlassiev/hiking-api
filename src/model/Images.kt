...
data class Image(val imageId: String, val location: String, val thumbnail: String, val description: String, val timestamp: Long, val gps: GpsData? = null, val variants: List<ImageVariant> = emptyList())
data class ImageVariant(val name: VariantName, val location: String)
enum class VariantName { DEFAULT, THUMBNAIL, V2048, V1024 }
